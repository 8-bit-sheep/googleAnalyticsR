...
The limiting factor willl then be the v4 [API limits](https://developers.google.com/analytics/devguides/config/mgmt/v3/limits-quotas), which are currently 10 queries per second per IP address, 1000 requests per 100 seconds per user. 
