...
## Metric expressions (Custom calculated metrics)

Metric expressions can be calculated on the fly by supply a named vector with the name of your created custom metric, and the calculation you are performing.  You need to supply the `ga:` prefix when creating custom metrics. 
...
An example is shown below, where a calculated metric is combined with a normal metric, `bounces`.
