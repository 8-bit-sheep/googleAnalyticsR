...
To use, you need to also install the [`bigQueryR`](https://github.com/MarkEdmondson1234/bigQueryR) library and authenticate to BigQuery:
...
just_query
# [1] "SELECT trafficSource.source as source, trafficSource.medium as medium, COUNT(fullVisitorId) as users # FROM (TABLE_DATE_RANGE([dataset-id-ga-viewid.ga_sessions_], TIMESTAMP('2016-01-01'),
# TIMESTAMP('2016-02-01'))) GROUP BY source, medium  LIMIT 100"
```

You could then paste this query into BigQuery interface. 
