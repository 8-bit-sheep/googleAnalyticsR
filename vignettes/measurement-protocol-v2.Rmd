...
The connection is configured with the API secret and your measurementId. Ideally the API secret should be set in your `.Renviron` file via environment argument `GA_MP_SECRET` 
