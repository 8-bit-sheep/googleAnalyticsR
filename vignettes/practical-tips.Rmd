...
The `google_analytics_meta()` function returns a table containing a list of all GA metrics and dimensions along with their definitions and other useful meta data. 
