...
You can visualise the dependencies here:

![](googleAnaytics_deepdep.png)
...
The easiest way to set this up is to create your own Google Cloud Platform project and then in R use the `ga_auth_setup()` function to walk you through the configuration below.
