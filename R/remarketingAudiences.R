...
#' @seealso [About remarketing audiences](https://support.google.com/analytics/answer/2611268?hl=en)
...
#' 
#' @param remarketingAudience A remarketing audience object from [ga_remarketing_get]
#' 
...
#' @param include A `ga4_remarketing_segment` object to include via [ga_remarketing_build]
#' @param exclude If `audienceType="STATE_BASED"`, a `ga4_remarketing_segment` object to exclude via [ga_remarketing_build]
#' @param audienceType `SIMPLE` or `STATE_BASED`
...
#' 
#' @seealso [Google Documentation](https://developers.google.com/analytics/)
#' 
#' @details 
...
#' 
#' 
#' @param RemarketingAudience The [RemarketingAudience] object to pass to this method
...
#' 
#' @param RemarketingAudience.audienceDefinition The [RemarketingAudience.audienceDefinition] object or list of objects
#' @param RemarketingAudience.stateBasedAudienceDefinition The [RemarketingAudience.stateBasedAudienceDefinition] object or list of objects
#' @param RemarketingAudience.stateBasedAudienceDefinition.excludeConditions The [RemarketingAudience.stateBasedAudienceDefinition.excludeConditions] object or list of objects
